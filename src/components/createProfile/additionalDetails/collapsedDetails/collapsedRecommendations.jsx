...
class CollapsedRecommendations extends React.Component{
    ...
    componentDidMount(){
        axios.get('http://localhost:9001/api/refereces/worker/'+localStorage.getItem("WorkerID"), {headers : this.headers}).then((res) => 
        {
    ...
    onDelete = async (id) => {
        await axios.delete('http://localhost:9001/api/refereces/'+id, {headers : this.headers}).then((res) => console.log(res))
